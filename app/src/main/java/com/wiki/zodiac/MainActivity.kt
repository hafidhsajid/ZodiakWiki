...
//            Toast.makeText(this, "Anda memilih: ${zodiacName[position]}", Toast.LENGTH_SHORT).show()
//            Toast.makeText(this, "Anda memilih: ${position}", Toast.LENGTH_SHORT).show()


//            if (id == position) {
            val new = Intent(this@MainActivity, DetailActivity::class.java)
            new.putExtra("nama", zodiacName[position])
            new.putExtra("date", zodiacDate[position])
            new.putExtra("sebutan", zodiacSebutan[position])
            new.putExtra("detail", zodiacDetail[position])
            new.putExtra("image", zodiacImage[position])
            startActivity(new)
//            }
        }
    ...
    override fun onOptionsItemSelected(item: MenuItem): Boolean {
        ...
        if (id == R.id.btnSaya) {
//            Toast.makeText(this, "Anda memilih: ${id}", Toast.LENGTH_SHORT).show()
